...
export default {
  ...
  'feed.getPosts': ['GET', '/feed/posts'],
  'feed.likePost': ['POST', '/feed/post/like'],
  'diary.getSummary': ['GET', '/diary/summary'],
  'diary.getMeals': ['GET', '/diary/meals'],
  'diary.addFood': ['POST', '/diary/meal/add'],
  'diary.deleteFood': ['DELETE', '/diary/meal/food'],
  'user.getStats': ['GET', '/user/stats'],
  'food.getList': ['GET', '/food/list'],
  'food.recognize': ['POST', '/food/recognize'],
  'food.getDetail': ['GET', '/food/detail'],
  'food.getCategories': ['GET', '/food/categories']
};
